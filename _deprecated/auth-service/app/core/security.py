...
class SecurityManager:
    ...
    def generate_password_reset_token(self, user_id: str) -> str:
        ...
        payload = {
            ...
            + timedelta(hours=self.password_reset_expire_hours),
    ...
    def create_access_token(
        self, user_id: str, organization_id: str, permissions: List[str]
    ) -> str:
...
class TwoFactorManager:
    ...
    def generate_qr_code(user_email: str, secret: str) -> str:
        ...
        totp_uri = pyotp.totp.TOTP(secret).provisioning_uri(
            name=user_email, issuer_name="Aiser Platform"
        )
...
class PermissionManager:
    ...
    def has_any_permission(
        cls, user_permissions: List[str], required_permissions: List[str]
    ) -> bool:
...
async def get_current_organization(
    ...
    result = await session.execute(
        ...
        .where(OrganizationUser.is_active)
    )
