...
class StreamingChatService:
    ...
    async def stream_chat(
        ...
        try:
            ...
            if data_source_id:
                try:
                    import requests
                    data_response = requests.get(f"http://localhost:8000/data/sources/{data_source_id}/data")
    ...
    def _update_session_context(self, conversation_id: str, user_query: str, ai_response: str):
    ...
    def _infer_user_goal(self, query: str) -> str:
        ...
        elif any(word in query_lower for word in ['analyze', 'analysis', 'insight', 'trend']):
            return 'analysis'
