...
def upgrade() -> None:
    conn = op.get_bind()
    # Populate NULL slugs with deterministic values derived from name
    ...
    # Ensure created_at has server default and not null
...
def downgrade() -> None:
    ...
    # Do not revert slug constraint removal automatically
