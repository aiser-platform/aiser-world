...
def upgrade() -> None:
    ...
    op.create_index('idx_dashboard_widgets_widget_type', 'dashboard_widgets', ['widget_type'])
    op.create_index('idx_dashboard_widgets_is_visible', 'dashboard_widgets', ['is_visible'])
