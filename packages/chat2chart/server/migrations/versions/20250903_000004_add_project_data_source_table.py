...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index(
        "idx_project_data_source_project_id", "project_data_source", ["project_id"]
    )
    op.create_index(
        "idx_project_data_source_data_source_id",
        "project_data_source",
        ["data_source_id"],
    )
    op.create_index(
        "idx_project_data_source_is_active", "project_data_source", ["is_active"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_project_data_source_data_source_id", table_name="project_data_source"
    )
    op.drop_index(
        "idx_project_data_source_project_id", table_name="project_data_source"
    )
