...
from sqlalchemy import Column, String, Integer, DateTime, Boolean, Text, JSON, ForeignKey, Numeric, Enum
...
class UsageRecord(Base):
    ...
    # Usage details
    metric_name = Column(String(100), nullable=False)  # e.g., "api_calls", "storage_gb", "ai_credits"
