        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    user_info = await self._get_user_info_from_token(token_data['access_token'])
...
class AuthProviderFactory:
    ...
    @staticmethod
    def create_provider(provider_type: AuthProvider, config: Dict[str, Any]) -> BaseAuthProvider:
