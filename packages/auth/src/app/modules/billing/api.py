...
async def get_usage_statistics(
    ...
    try:
        ...
        result = await usage_service.get_usage_stats(
            organization_id=organization_id, start_date=start_dt, end_date=end_dt, db=db
        )
...
async def check_usage_limits(
    ...
    try:
        ...
        result = await usage_service.check_usage_limits(
            organization_id=organization_id, tokens_requested=tokens_requested, db=db
        )
...
async def get_billing_report(
    ...
    try:
        ...
        result = await usage_service.generate_billing_report(
            organization_id=organization_id, month=month, year=year, db=db
        )
