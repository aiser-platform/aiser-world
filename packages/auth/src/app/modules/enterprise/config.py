...
class EnterpriseConfig:
    ...
    def from_env(cls) -> 'EnterpriseConfig':
        ...
        return cls(
            ...
            default_organization_name=os.getenv('DEFAULT_ORG_NAME', 'Default Organization'),
            auto_create_organizations=os.getenv('AUTO_CREATE_ORGS', 'true').lower() == 'true',
...
class DatabaseConfig:
    ...
    def from_env(cls) -> 'DatabaseConfig':
        ...
        return cls(
            ...
            enable_read_write_split=os.getenv('DB_READ_WRITE_SPLIT', 'false').lower() == 'true'
        )
