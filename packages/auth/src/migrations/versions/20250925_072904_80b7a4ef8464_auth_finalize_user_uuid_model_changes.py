"""auth: finalize user uuid model changes

Revision ID: 80b7a4ef8464
Revises: f6518f2e6112
Create Date: 2025-09-25 07:29:04.406528
...
revision: str = '80b7a4ef8464'
down_revision: Union[str, None] = 'f6518f2e6112'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name=op.f('dashboards_project_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('dashboards_pkey'))
    )
