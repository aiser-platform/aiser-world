...
def upgrade():
    ...
    op.create_table('organizations',
        ...
        sa.Column('ai_credits_limit', sa.Integer(), nullable=False, server_default='50'),
    ...
    op.create_index('idx_ai_usage_logs_organization_id', 'ai_usage_logs', ['organization_id'])
    op.create_index('idx_ai_usage_logs_created_at', 'ai_usage_logs', ['created_at'])
    op.create_index('idx_users_external_provider', 'users', ['external_provider', 'external_id'])
