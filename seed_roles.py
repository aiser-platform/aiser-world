    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if access_token:
                ...
                print(
                    f"Organization creation response status: {org_response.status_code}"
                )
                ...
                if org_response.status_code == 200:
                    ...
                    if org_response.status_code == 500:
                        ...
                        print(
                            "The issue is likely that the default roles (owner, admin, member) don't exist."
                        )
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(
            "❌ Roles need to be seeded. Check the database and insert default roles."
        )
