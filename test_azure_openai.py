...
def test_azure_openai():
    ...
    deployment_names = ["gpt-5-mini", "gpt-4o-mini", "gpt-4", "gpt-35-turbo"]
    ...
    for deployment in deployment_names:
        ...
        try:
            ...
            print(
                f"✅ SUCCESS with {deployment}: {response.choices[0].message.content}"
            )
            return deployment
...
if __name__ == "__main__":
    ...
    if working_deployment:
        ...
        print(
            f"Update your .env file with: AZURE_OPENAI_DEPLOYMENT_NAME={working_deployment}"
        )
    else:
